...
public class EmployeApp {
    public static void main(String[] args) {
        ...
        /*
        employee tipenya tetap Employee, tapi karena di deklarasikan sebagai new Manager maka pada saat
        method sayHello di panggil, maka yang di panggil adalah method punya class Manager. Walaupun tipe datanya
       Employee.
    ...
    /* Method ini menggunakan parameter Employee, sehingga class Manager dan ViceManager bisa menggunakannya.
    Karena Employe adalah Class tertinggi yang di exteds oleh class Manager, dan Class manager di extends oleh
    ViceManager. Intinya kalau parameter nya class tertinggi, maka bisa di akses juga oleh class yang menjadi
    turunannya.
    ...
    static void sayHello(Employee employee){
        ...
        if (employee instanceof ViceManager){
            ...
            System.out.println("Hai Vice Manager " + vicemanager.nama);
        }
...
//        else if (employee instanceof ViceManager){
//            /*Code di bawah ini adalah untuk melakukan konversi dari employee ke manager.
//            Sebenarnya jika tidak dikonversipun method sudah jadi. tapi apabila ingin dikonversi ke tipe data
//            ViceManager.
//             */
